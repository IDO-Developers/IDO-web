                    ...
                    <div class="card-body   " ; >
                        ...
                        <form method="POST" action="{{route('/signup')}}">
                            ...
                            <div class="form-group row " >
                                ...
                                <label for="RNE_Alumno" class="col-md-2 col-form-label text-md-right " >{{ __('Identidad') }} </label>

                                <div class="col-md-9">

                                    <input id="RNE_Alumno"  readonly=»readonly» type="text" class=" form-control @error('RNE_Alumno') is-invalid @enderror"  name="RNE_Alumno" value="{{ old('RNE_Alumno',Auth::user()->getGradoAttribute()[0]['RNE_Alumno'] )}}" required autocomplete="RNE_Alumno" autofocus >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @if(Auth::user()->getGradoAttribute()[0]['Sexo'] == "M")
                                        <input id="Sexo" type="text" readonly=»readonly» class="form-control @error('Sexo') is-invalid @enderror" name="Sexo" value="{{ old('Sexo','Masculino')}}" required autocomplete="Sexo" autofocus >

                                        @else
                                        <input id="Sexo" type="text" readonly=»readonly» class="form-control @error('Sexo') is-invalid @enderror" name="Sexo" value="{{ old('Sexo','Femenino')}}" required autocomplete="Sexo" autofocus >
                            ...
                            <div class="form-group row">
                                ...
                                <label for="Centro" class="col-md-2 col-form-label text-md-right">{{ __('Centro ') }} </label>

                                <div class="col-md-9">

                                    <input id="Centro" readonly=»readonly» type="text" class="form-control @error('Centro') is-invalid @enderror" name="Centro" value="{{ old('Centro',Auth::user()->getGradoAttribute()[0]['Centro_Procedencia'])}}" required autocomplete="Centro" autofocus >
                            ...
                            <div class="form-group row">
                                <label for="Grado" class="col-md-2 col-form-label text-md-right">{{ __('Grado') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="Grupo" class="col-md-2 col-form-label text-md-right">{{ __('Grupo')}}</label>
                            ...
                            <div class="form-group row">
                                <label for="Modalidad" class="col-md-2 col-form-label text-md-right">{{ __('Modalidad') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="Modulo" class="col-md-2 col-form-label text-md-right">{{ __('Módulo') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="Jornada" class="col-md-2 col-form-label text-md-right">{{ __('Jornada') }}</label>
